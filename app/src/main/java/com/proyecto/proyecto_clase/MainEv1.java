...
public class MainEv1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_main_ev1);

        cronometro =(Chronometer)findViewById(R.id.cronometro);
        fondo= (LinearLayout)findViewById(R.id.fondolayout);
        start =(Button)findViewById(R.id.startx);
        detener =(Button)findViewById(R.id.stop);
        btcorrer =(Button)findViewById(R.id.correr);
        btdescansar =(Button)findViewById(R.id.descansar);
        ...
        getSupportActionBar().setTitle("Ejercicios de velocidad 1");
    ...
    public void correr(View vista){
        ...
        timer30 = new CountDownTimer(30000, 1000) {
    ...
    public void descansar(View vista){
        ...
        btdescansar.setEnabled(false);
        timer30.cancel();
        timer60 = new CountDownTimer(60000, 1000) {
